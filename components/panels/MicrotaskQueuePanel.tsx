            ...
            <div className="space-y-2">
              {microtaskQueue.map((task, index) => (
                <motion.div
                  ...
                  className="rounded-lg border-2 border-purple-500/50 bg-purple-500/10 p-3"
                >
                  <div className="flex items-center gap-2">
                    <motion.div
                    ...
                    />
                    <span className="text-purple-400 font-medium">{task.name}</span>
                  </div>
